...
namespace ShaneBair.Sitecore.TabbedSelectRenderingDialog.Extensions.Dialogs
{
    /// <summary>
    /// Represents a Item Lister Form.
    /// </summary>
    [UsedImplicitly]
    public class TabbedSelectRenderingDialog : SelectItemWithThumbnailForm
    {
        protected Tabstrip Tabs;
        protected GridPanel MainGridPanel;
        protected GridPanel TabbedGridPanel;
        protected GridPanel DefaultGridPanel;
        ...
        #region All the Stuff from Sitecore
        /// <summary>
